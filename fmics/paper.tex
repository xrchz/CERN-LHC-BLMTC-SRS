...
\begin{enumerate}
\item The shift register of each slice (except the first) is updated once the shift register of its previous\footnote{Here, previous slice refers to the slice whose output is used as input to this slice.} slice is completely updated; an update means refreshing the value of every cell in the shift register.
