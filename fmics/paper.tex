...
The output of slice n at update time t ... (statement of the theorem)
...
\item
$\mathsf{output}\;D\;n\;x\;t$ is a sum of values of consecutive shift register cells (Theorem~(\ref{output_sum})), which can be proved by induction on $t$;
\item
