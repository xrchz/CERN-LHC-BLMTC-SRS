...
In this paper, we describe a formal verification approach based on logical deduction, using HOL4 theorem prover~\cite{HOL4,DBLP:conf/tphol/SlindN08}, for analyzing the SRS implementation.
