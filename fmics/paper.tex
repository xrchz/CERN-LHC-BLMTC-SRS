...
The main strategy for protecting the LHC from quenches is the Beam Loss Monitoring (BLM) system, which stops the beams safely if the particle loss exceeds thresholds that are likely to result in a quench. 
At each cycle of the beams around the LHC, the BLM system records and processes thousands of data points in order to decide whether to stop the beams.
