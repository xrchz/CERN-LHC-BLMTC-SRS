...
Update: Contrary to my earlier warning when I write \HOLtm{SIGMA (\m. f m) (count (SUC b))} I now mean for the variable $m$ to range from $0$ up to \emph{and including} $b$, as per the usual convention.
